...
def three_bet_equity(*, hand, steal, fold_percentage, fourbet):
    ...
    equity_on_the_flop = range_battle([hand], sb_call_range) * 0.9
    call_equity = (100 - fold_percentage - fourbet) / 100 * (
            2 * three_bet_size * equity_on_the_flop - three_bet_size)

    # If he 4bets, we suppose that we always fold
    four_bet_equity = fourbet / 100 * -three_bet_size
